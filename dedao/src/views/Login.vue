...
export default {
  name:'Login',
  created(){
    this.$on('Friendship', this.Galaxy);
  },
  ...
  methods:{
    ...
    addVerification(){
      let i = 5
      const closure = setInterval(function (){
        i--
        if( i === 0){
